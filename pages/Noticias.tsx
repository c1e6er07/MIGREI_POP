    ...
    if (data.length > 0) {
      ...
      setNews([
        ...
        },
        {
          ...
          summary:
            'Sancionada em 24/11/2025, a nova lei moderniza o setor elétrico e cria o conceito de comercialização varejista, permitindo que consumidores residenciais escolham seu fornecedor de energia em até 36 meses.',
        ...
        },
        {
          ...
          summary:
            'Consumidores industriais e comerciais atendidos em tensão ≥ 2,3 kV poderão migrar para o Ambiente de Contratação Livre a partir de novembro de 2027, com produto padrão e preço de referência.',
          category: 'Regulatório',
          image_url:
        ...
        },
        {
          ...
          summary:
            'A partir de 2028, consumidores residenciais (Grupo B) poderão escolher livremente seu fornecedor de energia, democratizando o acesso ao Mercado Livre e promovendo competitividade no setor.',
          category: 'Mercado',
          image_url:
            'https://images.unsplash.com/photo-1466611653911-95081537e5b7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
          date: '2025-11-29',
                ...
                <div className="relative bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden grid md:grid-cols-2 shadow-2xl">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="px-3 py-1 bg-emerald-500 text-slate-950 text-xs font-bold uppercase rounded-full">
                        {item.category}
                      </span>
                    ...
                    <h2 className="text-3xl font-bold text-white mb-4 leading-tight group-hover:text-emerald-400 transition-colors">
                      {item.title}
                    </h2>

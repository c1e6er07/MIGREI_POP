      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl w-full max-w-md shadow-2xl">
          ...
          <p className="text-slate-400 text-center mb-8 text-sm">
            Painel exclusivo para Gestores MIGREI.
          </p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-slate-900 border border-slate-700 hover:bg-red-900/20 hover:border-red-900/50 hover:text-red-400 text-slate-300 rounded-lg transition-all text-sm font-bold"
          >
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-xl">
            <div className="p-4 border-b border-slate-800 flex justify-between items-center bg-slate-950/50">
              <h2 className="font-bold text-white flex items-center gap-2">
                <Filter className="w-4 h-4" /> Leads Recentes
              </h2>
              <div className="relative">
                ...
                <input
                  ...
                  className="bg-slate-950 border border-slate-700 rounded-full pl-9 pr-4 py-2 text-sm text-white focus:border-emerald-500 outline-none w-64"
                />
              </div>
            </div>
                        ...
                        <td className="p-4 text-right">
                          <div className="flex justify-end gap-2">
                            <button
                              ...
                              title="Atender"
                              className="p-2 hover:bg-orange-500/20 text-slate-400 hover:text-orange-500 rounded"
                            >
                            ...
                            <button
                              ...
                              title="Converter"
                              className="p-2 hover:bg-emerald-500/20 text-slate-400 hover:text-emerald-500 rounded"
                            >
                            ...
                            <button
                              ...
                              title="Arquivar"
                              className="p-2 hover:bg-red-500/20 text-slate-400 hover:text-red-500 rounded"
                            >
        ...
        {activeTab === 'news' && (
          <div className="text-center py-20 bg-slate-900 border border-slate-800 rounded-xl">
            ...
            <p className="text-slate-500">
              Funcionalidade em desenvolvimento. Em breve você poderá publicar artigos no blog.
            </p>
          </div>
        )}
      </div>

      ...
      <div className="space-y-8 bg-slate-900 p-8 md:p-12 rounded-2xl border border-slate-800">
        <section>
          ...
          <p className="leading-relaxed">
            Ao acessar e utilizar a plataforma MIGREI MLE CONSULT (&quot;Plataforma&quot;), você
            concorda em cumprir estes Termos de Uso e todas as leis aplicáveis. Se você não
        ...
        <section>
          ...
          <p className="leading-relaxed">
            A MIGREI fornece uma plataforma SaaS para gestão de energia, telemetria e processamento
            de pagamentos via PIX e Cartão. A Plataforma atua como facilitadora e consultora, não
            sendo uma distribuidora de energia.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="leading-relaxed">
            ...
            veracidade das informações fornecidas, incluindo faturas e dados bancários para o Open
            Finance.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="leading-relaxed">
            Todo o conteúdo, software, marcas e tecnologias (incluindo &quot;Smart Split&quot; e
            &quot;Migrei IA&quot;) são propriedade exclusiva da MIGREI MLE CONSULT ou de seus
            licenciadores.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="leading-relaxed">
            A MIGREI não se responsabiliza por falhas de fornecimento de energia por parte das
            distribuidoras, nem por oscilações no PLD (Preço de Liquidação das Diferenças) que fujam
            ao nosso controle consultivo.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="leading-relaxed">
            ...
            plataforma constitui aceitação dos novos termos.
          </p>
        </section>
      </div>
    </div>

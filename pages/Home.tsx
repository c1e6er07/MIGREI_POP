  ...
  const b2bServices = [
    {
      ...
      description: 'Análise completa de oportunidades de economia',
      items: [
        'Auditoria de contas',
        'Identificação de saídas regulatórias',
    ...
    },
    {
      ...
      description: 'Especialistas em mercado livre de energia',
      items: [
        'Orientação em migrações',
    ...
    },
    {
      icon: Megaphone,
      title: 'Implementação',
      description: 'Execução de estratégias energéticas',
      items: [
        'Setup de operação',
    ...
    },
    {
      ...
      description: 'Apoio legal especializado',
      items: ['Revisão de contratos', 'Parecer legal', 'Documentação', 'Compliance'],
    },
    {
      icon: Cpu,
      title: 'Plataforma Tecnológica',
      description: 'Sistema integrado de gestão',
      items: ['Migrei IA', 'Dashboard analytics', 'Integração APIs', 'Mobile app'],
    },
    {
      icon: Headphones,
      title: 'Suporte Dedicado',
      description: 'Time exclusivo para sua empresa',
      items: ['Account manager', 'Suporte 24/7', 'Reuniões estratégicas', 'Otimização contínua'],
    },
  ];
  const solutionMetrics = [
    {
      ...
      value: '30% - 40%',
      description: 'Redução de custos de energia',
      color: 'yellow',
    },
    {
      icon: LineChart,
      ...
      value: '30 - 60 dias',
      description: 'Desde análise até operação',
      color: 'orange',
    },
    {
      icon: TrendingUp,
      ...
      value: '8 - 12 meses',
      description: 'Retorno do investimento em consultoria',
      color: 'amber',
    },
    {
      icon: Clock,
      ...
      value: '24/7',
      description: 'Acompanhamento permanente',
      color: 'yellow',
    },
    {
      icon: Target,
      ...
      value: '500+',
      description: 'Clientes satisfeitos no Brasil',
      color: 'orange',
    },
    {
      icon: Percent,
      ...
      value: '100%',
      description: 'Migrações bem-sucedidas',
      color: 'amber',
    },
  ];
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-slate-300 mb-8 text-xl lg:text-2xl leading-relaxed">
                ...
                Energia. MIGREI faz isso acontecer.{' '}
              </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -10 }}
              className="relative group p-8 rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-slate-800 hover:border-emerald-500/50 transition-all duration-500"
            >
              {' '}
              <div className="absolute inset-0 bg-gradient-to-b from-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl"></div>{' '}
              <div className="w-14 h-14 bg-slate-950 rounded-2xl flex items-center justify-center mb-6 border border-slate-800 group-hover:border-emerald-500/50 shadow-lg shadow-emerald-500/10">
                {' '}
                <TrendingUp className="w-7 h-7 text-emerald-400" />{' '}
              </div>{' '}
              <h3 className="text-2xl font-bold text-white mb-2">Expertise Comprovada</h3>{' '}
              <div className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 mb-4">
                500+
              </div>{' '}
              <p className="text-slate-400 leading-relaxed text-sm">
                Empresas atendidas com sucesso desde 2022. Especialistas certificados no Mercado
                Livre de Energia.
              </p>{' '}
            </motion.div>
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="relative group p-8 rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-slate-800 hover:border-cyan-500/50 transition-all duration-500"
            >
              {' '}
              <div className="absolute inset-0 bg-gradient-to-b from-cyan-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl"></div>{' '}
              <div className="w-14 h-14 bg-slate-950 rounded-2xl flex items-center justify-center mb-6 border border-slate-800 group-hover:border-cyan-500/50 shadow-lg shadow-cyan-500/10">
                {' '}
                <Cpu className="w-7 h-7 text-cyan-400" />{' '}
              </div>{' '}
              <h3 className="text-2xl font-bold text-white mb-2">Tecnologia Proprietária</h3>{' '}
              <div className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400 mb-4">
                100%
              </div>{' '}
              <p className="text-slate-400 leading-relaxed text-sm">
                Plataforma integrada com IA, análise de dados e simuladores. Tudo que você precisa
                em um único lugar.
              </p>{' '}
            </motion.div>
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="relative group p-8 rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-slate-800 hover:border-blue-500/50 transition-all duration-500"
            >
              {' '}
              ...
              <div className="w-14 h-14 bg-slate-950 rounded-2xl flex items-center justify-center mb-6 border border-slate-800 group-hover:border-blue-500/50 shadow-lg shadow-blue-500/10">
                {' '}
              ...
              <div className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 mb-4">
                8-12m
              </div>{' '}
              <p className="text-slate-400 leading-relaxed text-sm">
                Tempo para recuperar o investimento em consultoria. Economia média de 30-40% em seus
                custos de energia.
              </p>{' '}
            </motion.div>
          </div>
          ...
          >
            <Link to="/empresas" className="inline-flex items-center group relative">
              {' '}
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-lg blur opacity-40 group-hover:opacity-75 transition-opacity animate-pulse"></div>{' '}
              <button className="relative px-8 py-4 bg-slate-950 border border-emerald-500/50 rounded-lg text-white font-bold text-lg flex items-center gap-3 transition-transform group-hover:scale-[1.02]">
                {' '}
                <Briefcase className="w-5 h-5 text-emerald-400" /> Explorar Soluções{' '}
                <ChevronRight className="w-5 h-5 text-slate-500 group-hover:text-white transition-colors" />{' '}
              </button>{' '}
            </Link>
            <div className="mt-8 flex items-center justify-center">
              {' '}
              <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full backdrop-blur-md shadow-[0_0_15px_rgba(16,185,129,0.1)]">
                {' '}
                <CheckCircle2 className="w-5 h-5 text-emerald-500" />{' '}
                <span className="text-slate-300 text-sm font-medium">
                  {' '}
                  Diagnostico <span className="text-emerald-400 font-bold">Gratuito</span> para sua
                  Empresa{' '}
                </span>{' '}
              </div>{' '}
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <p className="text-lg text-slate-400 mb-8 leading-relaxed">
                {' '}
                Milhões de empresas ainda não sabem que podem reduzir drasticamente seus custos de
                energia. Esse é o seu diferencial competitivo.{' '}
              </p>{' '}
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 bg-slate-900/50 p-4 rounded-xl border border-emerald-500/20">
                  ...
                  <div>
                    {' '}
                    <h4 className="font-bold text-white">Mercado em Expansão</h4>{' '}
                    <p className="text-sm text-slate-400">
                      Governo amplificando acesso de PMEs ao mercado livre de forma progressiva.
                    </p>{' '}
                  </div>{' '}
                </div>{' '}
                <div className="flex items-start gap-4 bg-slate-900/50 p-4 rounded-xl border border-cyan-500/20">
                  ...
                  <div>
                    {' '}
                    <h4 className="font-bold text-white">Crescimento Consistente</h4>{' '}
                    <p className="text-sm text-slate-400">
                      Setor cresce mais de 20% ao ano. Tendência irreversível de descentralização.
                    </p>{' '}
                  </div>{' '}
                </div>{' '}
              </div>{' '}
            ...
            <div className="flex flex-col gap-8">
              ...
              >
                {' '}
                {solutionMetrics.map((stat, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    ...
                    className={`bg-slate-900/80 backdrop-blur-sm p-6 rounded-2xl border ${stat.color === 'yellow' ? 'border-emerald-500/30' : stat.color === 'orange' ? 'border-cyan-500/30' : 'border-blue-500/30'} hover:bg-slate-800 transition-colors`}
                  >
                    {' '}
                    <stat.icon
                      className={`w-10 h-10 mb-4 ${stat.color === 'yellow' ? 'text-emerald-400' : stat.color === 'orange' ? 'text-cyan-400' : 'text-blue-400'}`}
                    />{' '}
                    <div
                      className={`text-2xl md:text-3xl font-black mb-1 ${stat.color === 'yellow' ? 'text-emerald-400' : stat.color === 'orange' ? 'text-cyan-400' : 'text-blue-400'}`}
                    >
                      {stat.value}
                    </div>{' '}
              ...
              >
                ...
                <Link
                  to="/contato"
                  className="w-full inline-flex items-center justify-center px-10 py-4 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-slate-950 rounded-xl font-bold text-lg shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all hover:scale-[1.05] gap-2"
                >
                  {' '}
                  <Briefcase className="w-5 h-5" /> Agende uma Consulta Gratuita{' '}
                </Link>{' '}
              </motion.div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-extrabold text-white mb-4">
              ...
              <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">
                Precisa Para Economizar
              </span>
            </h2>
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              Consultoria integrada, tecnologia proprietária e suporte dedicado para sua migração no
          ...
          >
            <h3 className="text-3xl font-bold text-white mb-4">
              Transforme Esses Serviços em Economia Real
            </h3>
            <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
              Não é só consultoria. É um{' '}
              <span className="text-emerald-400 font-bold">sistema completo</span> que gera economia
              de <span className="text-emerald-400 font-bold">30-40%</span> desde o primeiro mês.
            </p>

            <Link
              to="/empresas"
              className="inline-flex items-center justify-center px-12 py-4 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-slate-950 rounded-xl font-bold text-lg shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all hover:scale-[1.05] gap-2"
            >
      ...
      <section className="py-24 bg-slate-950 border-t border-slate-800 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              Seus custos de energia diminuem, sua taxa de retorno é garantida e você ganha um
              parceiro estratégico no Mercado Livre de Energia.
            </p>
          </motion.div>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-bold text-white">
                        8-12 meses de ROI (Retorno sobre Investimento)
                      </div>
                      <div className="text-sm text-slate-400">
                        Retorno 100% do investimento em consultoria
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-400">
                        Ganho contínuo enquanto ficar no mercado livre
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-300">
                      Economia média: <span className="font-bold text-yellow-400">R$ 150k/ano</span>{' '}
                      por empresa. Alguns chegam a{' '}
                      <span className="font-bold text-yellow-400">R$ 500k+/ano</span>.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-slate-900/60 border border-slate-800 rounded-3xl p-8 mb-16 backdrop-blur-sm"
          >
            <div className="text-center mb-10">
              <h3 className="text-3xl font-bold text-white mb-2">
                Veja a Diferença Entre <span className="text-red-400">Fazer Sozinho</span> vs.{' '}
                <span className="text-emerald-400">Ter a MIGREI</span>
              </h3>
              <p className="text-slate-400">
                Compare os resultados e decida o melhor caminho para sua empresa
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="relative">
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 z-10">
                  <div className="bg-gradient-to-r from-emerald-500 to-cyan-500 px-4 py-1.5 rounded-full text-sm font-bold text-white shadow-lg shadow-emerald-500/50">
                    ✨ RECOMENDADO
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/30 rounded-xl p-6">
                  <div className="space-y-3">
                    ...
                    <div className="text-2xl font-black text-emerald-400 mt-6">
                      Investimento: R$ 2.990-5.990/mês
                    </div>
                    <div className="text-xl font-bold text-emerald-400">
                      ROI (Retorno sobre Investimento): 8-12 meses
                    </div>
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                Nosso diagnóstico é{' '}
                <span className="font-bold text-emerald-400">100% gratuito e sem compromisso</span>.
                Em 48 horas você terá a análise completa.
              </p>
            </div>

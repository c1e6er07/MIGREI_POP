      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              {' '}
              <a
                href="https://www.instagram.com/migrei.oficial/"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/migrei/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-500 hover:text-emerald-400 transition-colors"
                title="LinkedIn"
              ...
              <a
                href="https://www.facebook.com/migrei/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-500 hover:text-emerald-400 transition-colors"
                title="Facebook"
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li>
                <Link
                  ...
                  className="hover:text-emerald-400 transition-colors flex items-center gap-2"
                >
                  <ArrowRight className="w-3 h-3 text-emerald-500" /> Migrei IA
                </Link>
              </li>
            </ul>{' '}
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li>
                <Link to="/noticias" className="hover:text-emerald-400 transition-colors">
                  Notícias do Setor
                </Link>
              </li>{' '}
              <li>
                <Link to="/calculadora" className="hover:text-emerald-400 transition-colors">
                  Calculadora de Economia
                </Link>
              </li>{' '}
              <li>
                <Link to="/contato" className="hover:text-emerald-400 transition-colors">
                  Fale Conosco
                </Link>
              </li>{' '}
            </ul>{' '}
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-3 bg-slate-900/50 p-3 rounded-lg border border-slate-800">
                ...
                <span className="font-mono">{COMPANY_INFO.whatsapp}</span>{' '}
              </li>{' '}
              <li className="flex items-center gap-3 bg-slate-900/50 p-3 rounded-lg border border-slate-800">
                {' '}
                <Mail className="w-4 h-4 text-emerald-500" /> <span>{COMPANY_INFO.email}</span>{' '}
              </li>{' '}
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0 items-center">
            ...
            <Link
              to="/admin"
              className="flex items-center gap-1 ml-4 opacity-50 hover:opacity-100 hover:text-white transition-all"
            >
              {' '}

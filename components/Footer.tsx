    ...
    <footer className="bg-slate-950 border-t border-slate-800 pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1"> <div className="mb-6"> <img src={LOGO_URL} alt="MIGREI Logo" className="h-14 w-auto object-contain" /> </div> <p className="text-slate-400 text-sm mb-6 leading-relaxed"> Líder nacional em consultoria para o Mercado Livre de Energia. Transformamos custos em lucro através da inovação e tecnologia. </p> <div className="flex gap-4"> <a href="https://www.instagram.com/migrei.oficial/" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-emerald-400 transition-colors" title="Instagram"><Instagram className="w-5 h-5"/></a> <a href="https://www.linkedin.com/company/migrei/" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-emerald-400 transition-colors" title="LinkedIn"><Linkedin className="w-5 h-5"/></a> <a href="https://www.facebook.com/migrei/" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-emerald-400 transition-colors" title="Facebook"><Facebook className="w-5 h-5"/></a> </div> </div>
          <div> <h3 className="text-white font-bold mb-6 text-sm uppercase tracking-wider">Soluções</h3> <ul className="space-y-3 text-sm text-slate-400"> <li><Link to="/empresas" className="hover:text-emerald-400 transition-colors flex items-center gap-2"><ArrowRight className="w-3 h-3 text-emerald-500"/> Para Empresas</Link></li> <li><Link to="/migrei-ia" className="hover:text-emerald-400 transition-colors flex items-center gap-2"><ArrowRight className="w-3 h-3 text-emerald-500"/> Migrei IA</Link></li></ul> </div>

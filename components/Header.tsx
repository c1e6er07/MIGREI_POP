    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-xl border-b border-slate-800 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8"> <NavLink to="/" label="Início" /> <NavLink to="/sobre" label="Quem Somos" /> <NavLink to="/franquia" label="A Franquia" /> <NavLink to="/empresas" label="Para Empresas" /> <div className="h-4 w-px bg-slate-800 mx-2"></div> <NavLink to="/calculadora" label="Calculadora" /> <NavLink to="/noticias" label="News" /> <NavLink to="/contato" label="Contato" /> </nav>

...
import { Sparkles, TrendingUp, Users, Zap, ArrowRight, CheckCircle2, X, ExternalLink, ZoomIn } from 'lucide-react';
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg">Nova Lei do Mercado Livre de Energia</h3>
                  <p className="text-slate-400 text-sm">Lei 15.269/2025 - Infográfico Explicativo</p>
                </div>
              </div>
